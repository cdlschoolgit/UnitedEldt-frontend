...
import pic1 from '../images/pretrip3.png'
import pic2 from '../images/playbtn.png'
import { Link } from 'react-router-dom'
import { Translator, Translate } from "react-auto-translate";
function Cdlpretrip3() {
    const scrollToTop = () => {
        window.scrollTo({
          top: 0,
    ...
    <h1 className='camelcase'>   <Translate>Pre-trip inspection</Translate></h1>
    ...
    <div className='pretripimg mx-auto'>
                    {showIframe ? (
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/3qw2VhGT7w4?si=1pNVPMGXkjYU0Hhv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        ) : (
                        <>
                            <div className="card text-bg-dark bg-transparent">
    ...
    <div className='pretripquestions'>
        <div className='questionheading camelcase'>  <Translate>Air Brake Tests</Translate></div>
        <p>• <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>Parking Brake:</Translate> </span><Translate>release trailer brake (push RED valve IN), tug lightly against it.</Translate> <br /> <p>• <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>Service Brake:</Translate> </span><Translate>(brake pedal) release parking brake</Translate>   <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>(BOTH valves should be IN)</Translate></span> <Translate>, pull forward to</Translate> <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>5 mph</Translate></span><Translate>, depress clutch and brake while lightly gripping the steering wheel; check if vehicle pulls to the left or right.</Translate> <br /> </p></p>
        
        <div className='tipsheading'>
            <div><Translate>Tips</Translate>:</div>
            <ul>
                <li><Translate>Automatic Failure Warning</Translate> 
</li>
                <li><Translate>THE NEXT 4 STEPS MUST BE PERFORMED to avoid an automatic fail</Translate> </li>
                <li> <Translate>on the Pre-Trip. Pay special attention to the notes below regarding</Translate></li>
                <li> <Translate> the engine and the key.</Translate></li>
            </ul>
        ...
        <div className='timeline'>
            ...
            <ul>
                <li className='camelcase'>
                    <Link to="/Pretrip/questionA" onClick={scrollToTop}>
                ...
                </svg></span> #<Translate>Section A - Sides of the trucK</Translate>
                    </Link>
                   
                </li>
                <li className='camelcase'> 
                        <Link to='/Pretrip/questionB' onClick={scrollToTop}>
                        <span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M10.0013 18.3337C5.39893 18.3337 1.66797 14.6027 1.66797 10.0003C1.66797 5.39795 5.39893 1.66699 10.0013 1.66699C14.6036 1.66699 18.3346 5.39795 18.3346 10.0003C18.3346 14.6027 14.6036 18.3337 10.0013 18.3337ZM10.0013 16.667C13.6832 16.667 16.668 13.6822 16.668 10.0003C16.668 6.31843 13.6832 3.33366 10.0013 3.33366C6.3194 3.33366 3.33464 6.31843 3.33464 10.0003C3.33464 13.6822 6.3194 16.667 10.0013 16.667ZM8.85288 7.01248L12.9186 9.72299C13.0718 9.82508 13.1132 10.0321 13.0111 10.1852C12.9866 10.2218 12.9552 10.2532 12.9186 10.2777L8.85288 12.9882C8.69972 13.0903 8.49272 13.0489 8.39064 12.8957C8.35414 12.841 8.33464 12.7767 8.33464 12.7108V7.28983C8.33464 7.10573 8.48388 6.9565 8.66797 6.9565C8.7338 6.9565 8.79813 6.97598 8.85288 7.01248Z" fill="#FBB723" />
                        </svg></span> #<Translate>Section B - Side and Back of Truck + 1 Axle</Translate>
                        </Link>
                   
                        </li>
                        <li className='camelcase'>
                            <Link to="/Pretrip/questionC" onClick={scrollToTop}>
                            <span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="