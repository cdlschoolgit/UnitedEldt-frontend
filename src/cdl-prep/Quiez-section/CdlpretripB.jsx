...
import pic1 from '../images/pretripB.png'
import pic2 from '../images/playbtn.png'
import { Link } from 'react-router-dom'
import { Translator, Translate } from "react-auto-translate";
function CdlpretripB() {
    const scrollToTop = () => {
        window.scrollTo({
          top: 0,
