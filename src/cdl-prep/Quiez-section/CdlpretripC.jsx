...
import pic1 from '../images/pretripC.png'
import pic2 from '../images/playbtn.png'
import { Link } from 'react-router-dom'
import { Translator, Translate } from "react-auto-translate";
function CdlpretripC() {
    const scrollToTop = () => {
        window.scrollTo({
          top: 0,
    ...
    <div className='pretripquestions'>
        <div className='questionheading camelcase'><Translate>Section C - Trailer + 1 Axle</Translate></div>
        <p><Translate>You must say at least</Translate> <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>2 things about every item you inspect.</Translate> </span><Translate>Point to, or touch, every item that you inspect. You must point out any damaged items that you ﬁnd to the tester.</Translate> <br /> <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>Make It Easy: Connections–Start at Rear of Cab, end with Kingpin</Translate></span></p>
