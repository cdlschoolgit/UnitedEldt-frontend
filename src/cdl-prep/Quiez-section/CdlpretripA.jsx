...
import pic1 from '../images/pretripimg.png'
import pic2 from '../images/playbtn.png'
import { Link } from 'react-router-dom'
import { Translator, Translate } from "react-auto-translate";
function CdlpretripA() {
    const scrollToTop = () => {
        window.scrollTo({
            top: 0,
                    ...
                    {showIframe ? (
                        ...
                        <>
                            ...
                            <div className='pretripquestions' >
                                <div className='questionheading camelcase'><Translate>Section A - Front of the Truck</Translate></div>
                                <p><span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>Metal Parts:</Translate> </span><Translate>cannot be broken or cracked and must be securely mounted. Rubber Parts: no abrasions, bulges, or cuts. Parts that hold a Fluid or Air: cannot be leaking.</Translate> <br /> <span style={{ color: "#0A0A0A", fontWeight: "700" }}><Translate>Example: the engine air compressor (a metal part) is securely mounted, not cracked, gear-driven, and has no audible leaks.</Translate></span></p>
                                <div className='tipsheading'>
                                    <div><Translate>Tips:</Translate></div>
                                    <ul>
                                        <li> •<Translate>The Pre-Trip Inspection is a verbal test.</Translate></li>
                                        <li> • <Translate>Say at least 2 things about every item you inspect.</Translate></li>
                                        <li> •<Translate>Point to, or touch, every item that you inspect.</Translate> </li>
                                        <li> • <Translate>Mention all damaged items to the tester.</Translate></li>
                                    </ul>
                                ...
                                <div className='timeline'>
                                    ...
                                    <ul>
                                        ...
                                        <li className='camelcase'>
                                            <Link to="/Pretrip/question3" onClick={scrollToTop}>
                                                <span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path d="M10.0013 18.3337C5.39893 18.3337 1.66797 14.6027 1.66797 10.0003C1.66797 5.39795 5.39893 1.66699 10.0013 1.66699C14.6036 1.66699 18.3346 5.39795 18.3346 10.0003C18.3346 14.6027 14.6036 18.3337 10.0013 18.3337ZM10.0013 16.667C13.6832 16.667 16.668 13.6822 16.668 10.0003C16.668 6.31843 13.6832 3.33366 10.0013 3.33366C6.3194 3.33366 3.33464 6.31843 3.33464 10.0003C3.33464 13.6822 6.3194 16.667 10.0013 16.667ZM8.85288 7.01248L12.9186 9.72299C13.0718 9.82508 13.1132 10.0321 13.0111 10.1852C12.9866 10.2218 12.9552 10.2532 12.9186 10.2777L8.85288 12.9882C8.69972 13.0903 8.49272 13.0489 8.39064 12.8957C8.35414 12.841 8.33464 12.7767 8.33464 12.7108V7.28983C8.33464 7.10573 8.48388 6.9565 8.66797 6.9565C8.7338 6.9565 8.79813 6.97598 8.85288 7.01248Z" fill="#FBB723" />
                                                </svg></span> #<Translate>3-  Air brake test</Translate>
                                            </Link>
                                        </li>
