...
import pic1 from '../images/pretrip1.png'
import pic2 from '../images/playbtn.png'
import { Link } from 'react-router-dom'
import { Translator, Translate } from "react-auto-translate";
function Cdlpretrip1() {
    const scrollToTop = () => {
        window.scrollTo({
            top: 0,
            ...
            >
                ...
                <div style={{ background: "#F6F6F9", paddingBottom: "10px" }}>
                    ...
                    <div className='pretripimg'>
                        {showIframe ? (
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/3qw2VhGT7w4?si=1pNVPMGXkjYU0Hhv"   autoplay title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        ) : (
                            <>
                    ...
                    <div className='pretripquestions'>
                        <div className='questionheading camelcase'><Translate>Coupling - Connections</Translate></div>
