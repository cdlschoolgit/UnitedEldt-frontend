...
import bgofmain from "./Portugese.png"
import bgofmainsmal from "./Portugese.png"
...
<div className="price_section_english">
    <div>
        ...
        50% de desconto
          ...
          <svg className="svg-1" xmlns="http://www.w3.org/2000/svg" width="85" height="2" viewBox="0 0 85 2" fill="none">
...
<span className="dollare">
   $100.00
        ...
        </div> <div className="Main_price_area" style={{ marginTop: "20px" }}>
          $50.00
        </div>
    </div>
    <img src={moneybackgrenty} style={{height:"79px",width:"79px"}} alt="moneyback"/>       
</div>
...
export default ClassBPortugese;