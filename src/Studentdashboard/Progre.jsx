...
function Progre({handleNavigationClick}) {
  ...
  const [confirmLisence, setConfirmLisence] = useState('');
...
const formonth =(day)=>{
  ...
  const handleSave = (e) => {
    ...
    if (confirmLisence != licenseNumber) {
      errors.confirmLisence = 'License Number must be same';
    }
    ...
    if (selectedFile === null) {
      errors.selected = 'Image  is required';
    }
    if (lisencefile === null) {
      errors.lisence = 'Lisence/Permit Image  is required';
    }
  ...
  const handlelisenceupload = async (e) => {
    setLoading(false);
    ...
    if (file) {
      ...
      if (allowedTypes.includes(file.type)) {
        ...
        try {
          ...
          const data = await response.json();
          setLisencefile(data.secure_url);
          successnoti()
        } catch (error) {
          console.error('Error uploading image:', error);
          errornoti('error', 'Error uploading image. Please try again.');
...
<label className="foam-label">Your Image </label>
            <input
              className={`registinput ${errors.selected ? 'error-border' : ''}`}
              type="file"
              onChange={handleFileChange}
            />
              {errors.selected && <div className="error-message">

<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
<path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#FE2727" stroke-width="1.5" stroke-miterlimit="10"/>
<path d="M8 5V8.5" stroke="#FE2727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11.5C8.41421 11.5 8.75 11.1642 8.75 10.75C8.75 10.3358 8.41421 10 8 10C7.58579 10 7.25 10.3358 7.25 10.75C7.25 11.1642 7.58579 11.5 8 11.5Z" fill="#FE2727"/>
</svg>{errors.selected}</div>}
<label className="foam-label">Permit/License Images </label>
            <input
              className={`registinput ${errors.lisence ? 'error-border' : ''}`}
              type="file"
              onChange={handlelisenceupload}
            />
              {errors.lisence && <div className="error-message">

<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
<path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#FE2727" stroke-width="1.5" stroke-miterlimit="10"/>
<path d="M8 5V8.5" stroke="#FE2727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11.5C8.41421 11.5 8.75 11.1642 8.75 10.75C8.75 10.3358 8.41421 10 8 10C7.58579 10 7.25 10.3358 7.25 10.75C7.25 11.1642 7.58579 11.5 8 11.5Z" fill="#FE2727"/>
</svg>{errors.lisence}</div>}
...
<label className="foam-label">Confirm Permit number or license number</label>
            <input
              className={`registinput ${errors.confirmLisence ? 'error-border' : ''}`}
              type="text"
              placeholder="Confirm License Number"
              value={confirmLisence}
              onChange={(e) => setConfirmLisence(e.target.value)}
            />
               {errors.confirmLisence && <div className="error-message">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
<path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#FE2727" stroke-width="1.5" stroke-miterlimit="10"/>
<path d="M8 5V8.5" stroke="#FE2727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11.5C8.41421 11.5 8.75 11.1642 8.75 10.75C8.75 10.3358 8.41421 10 8 10C7.58579 10 7.25 10.3358 7.25 10.75C7.25 11.1642 7.58579 11.5 8 11.5Z" fill="#FE2727"/>
</svg>{errors.confirmLisence}</div>}

<label
 className="foam-label">Phone number </label>
            <input
              className={`registinput ${errors.phone ? 'error-border' : ''}`}
              type="text"
              placeholder="Phone Number"
              value={phone}
              onChange={(e) => setPhone(e.target.value)}
            />
               {errors.phone && <div className="error-message">

            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
<path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#FE2727" stroke-width="1.5" stroke-miterlimit="10"/>
<path d="M8 5V8.5" stroke="#FE2727" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 11.5C8.41421 11.5 8.75 11.1642 8.75 10.75C8.75 10.3358 8.41421 10 8 10C7.58579 10 7.25 10.3358 7.25 10.75C7.25 11.1642 7.58579 11.5 8 11.5Z" fill="#FE2727"/>
</svg>{errors.phone}</div>}
